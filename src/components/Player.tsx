  ...
  return (
    <section className="flex flex-col items-center justify-center px-4 pt-4 pb-6">
      ...
      <button
        ...
        className={`p-8 rounded-full border-4 border-gray-900 focus:outline-none focus-visible:ring ring-blue-400 disabled:cursor-default disabled:text-gray-500 disabled:border-gray-500 relative ${
