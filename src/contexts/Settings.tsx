...
type Envelope = { attack: number; decay: number; sustain: number; release: number }; // prettier-ignore
type Filter = { type: 'lowpass' | 'highpass' | 'bandpass'; frequency: number };
...
type Event =
  | { type: | 'ENABLE' | 'DECREMENT_OCTAVE' | 'INCREMENT_OCTAVE' | 'DECREMENT_VELOCITY' | 'INCREMENT_VELOCITY' } // prettier-ignore
